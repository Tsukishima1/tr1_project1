    ...
    <div class="grid-content bg-purple-light grid-contentbox">
        <ul>
            <li v-for="(diaryData, index) in diaryDatas" :key="index">
                <span class="date"
                    >{{ diaryData.date }} /
                    <span class="username">{{ diaryData.username }}</span>
                </span>
                <span class="editTime">编辑于{{ diaryData.editTime }}</span>
                <span class="content" @click="goDetails(diaryData.id)">{{ diaryData.content }}</span>
            </li>
        </ul>
    </div>
</template>
